...
const AccordionSummary = styled((props: AccordionSummaryProps) => (
  <MuiAccordionSummary
    expandIcon={<KeyboardArrowDownOutlined sx={{ fontSize: "1.5rem" }} />}
    {...props}
  />
))(({ theme }) => ({
...
const BackofficeDocumentDetail = () => {
  return (
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Box>
                  ...
                  <Typography sx={{ px: 3 }}>
                    Found user in narration - This is dummy text. This text can
                    be two line long giving a lot of space for reasoning.
                  </Typography>
                </Box>
              </AccordionDetails>
            </Accordion>
...
export default BackofficeDocumentDetail;
